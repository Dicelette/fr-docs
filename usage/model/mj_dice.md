...
Toutes les commandes fonctionnent de manière similaire à [dbroll](./dice.mdx#dbroll-dbroll), [macro](./dice.mdx#macro-macro), [calc](./calc.mdx#basé-sur-des-statistiques-calc) et [roll](../index.md), mais permettent en plus de spécifier le joueur pour lequel le jet est effectué. Comme pour les autres commandes, il est possible de choisir un personnage appartenant à ce joueur ou de laisser le choix par défaut.
