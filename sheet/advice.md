...
- Lors de l'édition d'une fiche, les statistiques ne sont ni vérifiées par rapport au total ni par rapport à un maximum. 
- De plus, il est impossible de contrôler les nombres de points dépensés par statistique dans les systèmes dans lequel 1 point dépensé dans une statistique n'est pas équivalent à 1 point de statistique.
