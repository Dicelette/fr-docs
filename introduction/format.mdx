...
- **`[commentaire]`**  
  - <CL>Usage :</CL> Ajoute un commentaire à une formule ou un résultat de dé.  
  - <CL>Où ?</CL> Après une formule de dé ou entre plusieurs formules partagées.  
  :::example `1d20;&-2[Perte de PV]` : Applique -2 et annote le résultat.
  :::
