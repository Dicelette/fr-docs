...
:::important
Les statistiques ne sont pas pris en charge dans les snippets, car ils ne sont pas liés à un personnage. Cependant, les [attributs](./attributes.md) le sont.
:::

:::danger
Les [attributs](./attributes.md) peuvent être utilisé dans un snippets tant que l'attribut existe déjà et est sauvegardé.
:::
