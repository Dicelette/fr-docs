...
- <CL>expression</CL> : D'éventuelles [expressions](./expression.md) mathématiques définissant des conditions ou des modifications (comme l'avantage ou le désavantage).
...
:::info
La commande `calc` permet de réaliser des calculs mathématiques à partir d'une statistique et d'y appliquer une [expression](./expression.md).
:::
