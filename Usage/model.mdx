...
### Modifier l'image (`/edit_avatar`)

:::usage
**`/edit_avatar [lien] (@joueur) (*personnage)`**
:::
...
Si l'embed ne possède pas le bouton `[MODIFIER L'IMAGE]`, le bouton sera automatiquement ajouté par la commande.